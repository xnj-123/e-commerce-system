        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(slide,index) in spuSaleAttrList" :key="slide.id">
                <dt class="title">{{ slide.saleAttrName }}</dt>
                <dd changepirce="0" @click="changeactive(spuSaleAttrValue,slide.spuSaleAttrValueList)" :class="{active:spuSaleAttrValue.isChecked == '1'}" v-for="(spuSaleAttrValue,index) in slide.spuSaleAttrValueList" :key="spuSaleAttrValue.id">{{ spuSaleAttrValue.saleAttrValueName }}</dd>
              </dl>
