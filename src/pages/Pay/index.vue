  ...
  export default {
    ...
    methods:{
      async getPayInfo(){
        ...
        this.imgUrl = result.data.codeUrl;
      },
      async open() {
        //返回的是promise!!!!
        let url = await QRCode.toDataURL(this.imgUrl);
    ...
    .catch(() => {});
        ...
        if(!this.time){
          this.time = setInterval(async ()=>{
            let result = await this.$API.getOrderState(this.orderId);
